...
exports.newOrder = AsyncAwaitError(async (req, res, next) => {
  ...
  // get Single Order
exports.getSingleOrder = AsyncAwaitError(async (req, res, next) => {
...
exports.myOrders = AsyncAwaitError(async (req, res, next) => {
...
exports.getAllOrders = AsyncAwaitError(async (req, res, next) => {
